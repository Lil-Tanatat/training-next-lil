    ...
    <div class="font-kanit antialiased bg-gray-50 text-gray-900">
        ...
        <div class="container mx-auto px-6">
          <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
              <button class="bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors duration-300 flex items-center justify-center gap-2">
                <span>เริ่มต้นเลย</span>
                <i class="fas fa-arrow-right"></i>
              </button>
              <button class="border-2 border-blue-600 text-blue-600 px-8 py-4 rounded-lg font-semibold hover:bg-blue-600 hover:text-white transition-colors duration-300 flex items-center justify-center gap-2">
      ...
      <section class="py-20 bg-gray-50">
        <div class="container mx-auto px-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {/* <!-- Value 1 --> */}
            <div class="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 text-center">
      ...
      <section class="py-16 bg-blue-600 text-white">
        <div class="container mx-auto px-6 text-center">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <button class="bg-white text-blue-600 px-8 py-3 rounded-md font-semibold hover:bg-gray-100 transition-colors duration-300 flex items-center justify-center gap-2">
              <i class="fas fa-phone"></i>
              <span>โทรเลย</span>
            </button>
            <button class="border-2 border-white text-white px-8 py-3 rounded-md font-semibold hover:bg-white hover:text-blue-600 transition-colors duration-300 flex items-center justify-center gap-2">
